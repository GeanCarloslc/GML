 ...
 * @author topga
 */
public class CaixaDebitoDao {
    
    private Connection conecta;

    public CaixaDebitoDao(Connection conecta) {
        this.conecta = conecta;
    }
    
    
    public ArrayList<CaixaDebitoModel> buscandoDadosDoPedido(CaixaDebitoModel model) {
        ...
        ArrayList<CaixaDebitoModel> lista = new ArrayList<>();
        
        while (rs.next()) { 
            CaixaDebitoModel dadosArrayList = new CaixaDebitoModel();
    ...
    public void utilizandoOInsert (CaixaDebitoModel model) throws SQLException{
        
        String sql = "INSERT INTO CAIXADEBITO(ID_CAIXA_FK, STATUS, ID_DO_PEDIDO_FK, VALOR_FINAL) VALUES (?,?,?,?)";
